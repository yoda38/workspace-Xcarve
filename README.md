# com-chilipeppr-workspace-my-xcarve
A ChiliPeppr Workspace my-xcarve.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / my-xcarve
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-my-xcarve |
| Name                  | Workspace / my-xcarve |
| Description           | A ChiliPeppr Workspace my-xcarve. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/yoda38/workspace-Xcarve/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/yoda38/my-xcarve |
| Github URL            | http://github.com/yoda38/workspace-Xcarve |
| Test URL              | https://preview.c9users.io/yoda38/my-xcarve/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/yoda38/workspace-Xcarve/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-my-xcarve"], // the id you gave your workspace
      function(myWorkspaceMyXcarve) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / my-xcarve just got loaded.", myWorkspaceMyXcarve);
        myWorkspaceMyXcarve.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-my-xcarve"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / my-xcarve"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace my-xcarve."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/yoda38/workspace-Xcarve/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/yoda38/my-xcarve"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/yoda38/workspace-Xcarve"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://my-xcarve-yoda38.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
