...
cprequire_test(["inline:com-chilipeppr-workspace-my-xcarve"], function(ws) {
    ...
    $('title').html("my-xcarve Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-my-xcarve", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-my-xcarve", // Make the id the same as the cpdefine id
        name: "Workspace / my-xcarve", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace my-xcarve.`,
        ...
        /**
         * Load the Template widget via chilipeppr.load() so folks have a my-xcarve
